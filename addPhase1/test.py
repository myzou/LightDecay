...
if __name__ == '__main__':
    ...
    #实际环境
    host_ip = '10.117.23.130'
    username = 'op976@ce'
    password = 'huawei852*'
    enablePwd = '123cpc'
    # read_xls(filename,SheetName,minrow=1000,maxrow=2000)
